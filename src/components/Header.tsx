      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-white bg-opacity-10 rounded-2xl p-8 backdrop-blur-sm mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: 'Anubhav Singh', company: 'Google', role: 'Software Engineer', location: 'Mountain View, CA' },
              { name: 'Amit Kumar Verma', company: 'Microsoft', role: 'SDE II', location: 'Seattle, WA' },
              { name: 'Ashutosh Kumar Gupta', company: 'Amazon', role: 'Software Developer', location: 'Berlin, Germany' },
              { name: 'Gaurav Kaushal', company: 'Meta', role: 'Frontend Engineer', location: 'London, UK' }
            ].map((student, index) => (
              <div key={index} className="bg-white bg-opacity-10 p-6 rounded-xl backdrop-blur-sm hover:bg-opacity-20 transition-all">
                ...
                <h4 className="font-semibold text-white text-center mb-2">{student.name}</h4>
                <p className="text-blue-200 text-sm text-center mb-1">{student.role}</p>
                <p className="text-blue-300 text-sm text-center font-medium">{student.company}</p>
                <p className="text-blue-400 text-xs text-center mt-1">{student.location}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-blue-600 p-6 rounded-xl">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Anubhav Singh', 'Amit Kumar Verma', 'Ashutosh Kumar Gupta', 'Gaurav Kaushal'].map((name, index) => (
